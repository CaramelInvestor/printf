 ...
 *
 * Return: return true || false function
 */
...
/**
 * dot_null - function to check for dot nolifiers
 *
...
/**
 * cfmt - function to check for specifier
 * @s: format double pointer
 *
 * Return: return format specifier function
 */
 ...
 * @no_perc: no of percentage count
...
/**
 * _printf - Printf cloned function
 * @format: format function
 * Return: return what is fomatted
 */
